...
<table width="520" cellpadding="0" cellspacing="0" border="0" style="max-width:520px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;">
  ...
  <tr>
    <td style="padding:0;line-height:0;">
      <img src="https://thatsdoneright.com/backgroundg.png" alt="Fresh mowed lawn" width="520" style="display:block;width:100%;max-width:520px;"/>
    </td>
  </tr>
  ...
  <tr>
    <td style="padding:20px 40px 24px;">
      <a href="https://thatsdoneright.com" style="display:block;background:#16a34a;color:#ffffff;text-decoration:none;text-align:center;font-size:16px;font-weight:700;padding:17px;border-radius:12px;">Get my $19.99 first mow &nbsp;&rarr;</a>
    </td>
  </tr>
